...
func init() {
	...
	rawSchema = nil
	MeshTrafficPermissionResourceTypeDescriptor.Validator = validator
	MeshTrafficPermissionResourceTypeDescriptor.StructuralSchema = structuralSchema
}
...
func (t *MeshTrafficPermissionResource) Validate() error {
	...
	for _, validator := range validators.GlobalValidatorRegistry().Get(MeshTrafficPermissionType) {
