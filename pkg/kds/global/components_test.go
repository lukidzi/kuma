...
var _ = Describe("Global Sync", func() {
	...
	Context("Delta KDS", func() {
		...
		BeforeEach(func() {
			...
			kds_setup.StartDeltaClient(clientStreams, []model.ResourceType{mesh.DataplaneType}, stopCh, sync_store_v2.CallbacksGlobal(globalSyncer, false, nil, "kuma-system"))
