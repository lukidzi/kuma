...
func (i *IdentityProviderReconciler) Start(stop <-chan struct{}) error {
	...
	for {
		...
		case <-ticker.C:
			...
			// status := map[kri.Identifier][]common_api.Condition{}
			for _, mid := range mids.Items {
				...
				// TODO: verify self signed
				// TODO: validate trust domain conflict
				// TODO: generate autogenerated
...
// func (i *IdentityProviderReconciler) updateStatus() {

// }

// func (i *IdentityProviderReconciler) processEvent(ctx context.Context, rk model.ResourceKey) error {
// 	mid := meshidentity_api.NewMeshIdentityResource()
// 	if err := i.roResManager.Get(ctx, mid, store.GetBy(rk)); err != nil {
// 		return errors.Wrapf(err, "could not get MeshIdentity")
// 	}

// 	switch mid.Spec.Provider.Type {
// 	case meshidentity_api.BundledType:
// 		// create autogenerated certs
// 		if pointer.DerefOr(mid.Spec.Provider.Bundled.Autogenerate.Enabled, false) {
// 			createAutogeneratedCertificates()
// 		}
// 		// load value
// 		loadCA()

// 		// default to create
// 		if pointer.DerefOr(mid.Spec.Provider.Bundled.MeshTrustCreation, meshidentity_api.MeshTrustCreationEnabled) == meshidentity_api.MeshTrustCreationEnabled {
// 			i.createOrUpdateMeshTrust()
// 		}
// 	}
// }

// func (i *IdentityProviderReconciler) createAutogeneratedCertificates(){
...
func (i *IdentityProviderReconciler) loadCA(ctx context.Context, identity *meshidentity_api.MeshIdentityResource, mesh string) ([]byte, error) {
	if identity.Spec.Provider.Type == meshidentity_api.BundledType {
		return identity.Spec.Provider.Bundled.Certificate.ReadByControlPlane(ctx, i.roResManager, mesh)
	}
	return nil, nil
}
