...
func NewSpireIdentityProvider(mountPath, socketFileName string) providers.IdentityProvider {
...
func (s *spireIdentityProvider) Initialize(ctx context.Context, identity *meshidentity_api.MeshIdentityResource, trustDomain string) error {
	return nil
}

// All certificates configuration is handled by the Spire
func (s *spireIdentityProvider) GetRootCA(ctx context.Context, identity *meshidentity_api.MeshIdentityResource, mesh string) ([]byte, error) {
	return nil, nil
}
...
func (s *spireIdentityProvider) CreateIdentity(ctx context.Context, identity *meshidentity_api.MeshIdentityResource, proxy *xds.Proxy, trustDomain string) (*xds.WorkloadIdentity, error) {
	if !proxy.Metadata.HasFeature(types.FeatureSpireSupported) {
