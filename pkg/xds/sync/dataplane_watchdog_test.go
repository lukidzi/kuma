...
func (s *staticIdentityProvider) Initialize(_ context.Context, _ *meshidentity_api.MeshIdentityResource, _ string) error {
	return nil
}
...
func (s *staticIdentityProvider) GetRootCA(_ context.Context, _ *meshidentity_api.MeshIdentityResource, _ string) ([]byte, error) {
	return nil, nil
}
	...
	BeforeEach(func() {
		...
		deps = sync.DataplaneWatchdogDependencies{
			...
			EnvoyCpCtx: &xds_context.ControlPlaneContext{
				Secrets:         secrets,
				Zone:            zone,
				IdentityManager: providers.NewIdentityProviderManager(plugins, eventBus, "default"),
			},
			MeshCache:  cache,
